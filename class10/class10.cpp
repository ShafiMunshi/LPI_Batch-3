...
int main()
{
    ...
    for (int i = 1; i <= 3; i++)
    { // first loop is called outer loop
        cout << "i is now = " << i << endl;
        for (int j = 1; j <= 5; j++)
        {                                   // this loop is called inner loop
    ...
    while (i <= 3)
    { // our first or outer while loop
        cout << "i is now = " << i << endl;
        int j = 1;
        while (j <= 5)
        { // second or inner loop
            cout << "j is = " << i << endl;
